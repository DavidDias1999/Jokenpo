...
$stoneButton1.addEventListener("click", function () {
  $fieldPlayer1.innerHTML = '<img class="move-img" src="assets/stone.png">';
  movePlayer1 = "stone";
  verifyGame();
  printGameResult()
});
...
$paperButton1.addEventListener("click", function () {
  $fieldPlayer1.innerHTML = '<img class="move-img" src="assets/paper.png">';
  movePlayer1 = "paper";
  verifyGame();
  printGameResult()
});
...
$scissorsButton1.addEventListener("click", function () {
  $fieldPlayer1.innerHTML = '<img class="move-img" src="assets/scissors.png">';
...
$stoneButton2.addEventListener("click", function () {
  $fieldPlayer2.innerHTML = '<img class="move-img" src="assets/stone.png">';
  movePlayer2 = "stone";
  verifyGame();
  printGameResult()
});
$paperButton2.addEventListener("click", function () {
  $fieldPlayer2.innerHTML = '<img class="move-img" src="assets/paper.png">';
  movePlayer2 = "paper";
  verifyGame();
  printGameResult()
});
...
$scissorsButton2.addEventListener("click", function () {
  $fieldPlayer2.innerHTML = '<img class="move-img" src="assets/scissors.png">';
